...
import { BlotterApi } from '@adaptabletools/adaptableblotter-angular-aggrid/adaptableblotter/types';
...
@Component({
  entryComponents: [],
  selector: 'blotter-angular-aggrid',
  template: `
...
export class BlotterAngularAggridComponent implements OnInit {
