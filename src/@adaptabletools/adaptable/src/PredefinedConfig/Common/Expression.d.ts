...
export declare class Expression {
    ColumnValueExpressions?: ColumnValueExpression[];
    FilterExpressions?: FilterExpression[];
    RangeExpressions?: RangeExpression[];
    /**
     ...
     */
    constructor(ColumnValueExpressions?: ColumnValueExpression[], FilterExpressions?: FilterExpression[], RangeExpressions?: RangeExpression[]);
}
/**
...
export interface QueryRange {
     ...
     */
    Operator: 'None' | 'GreaterThan' | 'LessThan' | 'Equals' | 'NotEquals' | 'GreaterThanOrEqual' | 'LessThanOrEqual' | 'Between' | 'Contains' | 'NotContains' | 'StartsWith' | 'EndsWith' | 'Regex' | 'AnyChange' | 'ValueChange' | 'PercentChange' | 'NotBetween' | 'IsPositive' | 'IsNegative' | 'IsNotNumber' | 'IsTrue' | 'IsFalse' | 'NoDuplicateValues' | 'ExistingValuesOnly' | 'PrimaryKeyDuplicate';
    /**
