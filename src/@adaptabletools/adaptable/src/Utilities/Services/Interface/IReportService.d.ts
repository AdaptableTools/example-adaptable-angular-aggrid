...
export interface IReportService {
    ...
    PublishLiveLiveDataChangedEvent(reportDestination: 'OpenfinExcel' | 'iPushPull' | 'Glue42', liveDataChangedTrigger: 'Connected' | 'Disconnected' | 'LiveDataStarted' | 'LiveDataStopped' | 'LiveDataUpdated', liveReport?: any): void;
}
