...
export interface UserInterfaceOptions {
     ...
     * **Default Value: true**
     */
    showAdaptableContextMenu?: boolean | ((menuItem: AdaptableMenuItem, menuInfo: MenuInfo) => boolean);
    /**
     ...
     * **Default Value: true**
     */
    showAdaptableColumnMenu?: boolean | ((menuItem: AdaptableMenuItem, menuInfo: MenuInfo) => boolean);
}
