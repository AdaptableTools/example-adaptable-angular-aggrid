...
export interface EventApi {
     ...
     */
    on(eventName: 'SearchChanged', callback: (searchChangedEventArgs: SearchChangedEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'SelectionChanged', callback: (selectionChangedEventArgs: SelectionChangedEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'ThemeChanged', callback: (themeChangedEventArgs: ThemeChangedEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'AlertFired', callback: (alertFiredEventArgs: AlertFiredEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'ActionColumnClicked', callback: (actionColumnClickedEventArgs: ActionColumnClickedEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'ColumnStateChanged', callback: (columnStateChangedEventArgs: ColumnStateChangedEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'ToolbarButtonClicked', callback: (toolbarButtonClickedEventArgs: ToolbarButtonClickedEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'ToolbarVisibilityChanged', callback: (toolbarVisibilityChangedEventArgs: ToolbarVisibilityChangedEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'LiveDataChanged', callback: (liveDataChangedEventArgs: LiveDataChangedEventArgs) => void): () => void;
    /**
     ...
     */
    on(eventName: 'AdaptableReady', callback: (adaptableReadyInfo: AdaptableReadyInfo) => void): () => void;
    emit(eventName: 'SelectionChanged' | 'SearchChanged' | 'ActionColumnClicked' | 'ThemeChanged' | 'AlertFired' | 'ColumnStateChanged' | 'ToolbarButtonClicked' | 'ToolbarVisibilityChanged' | 'LiveDataChanged' | 'AdaptableReady', data?: any): Promise<any>;
}
