...
export interface UpdatedRowApi {
    /**
     * Retrieves the Updated Row section from Adaptable State
     *
    ...
    /**
     * Enables the 'Jump To Row' option where Adaptable updates its scroll position to ensure the updated row is visible.
     */
    jumpToRowEnable(): void;
    /**
     * Disables the 'Jump To Row' option so that Adaptable will no not update its scroll position to ensure the updated row is visible.
     */
